      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-sm transition-all duration-300 h-14 sm:h-16 flex items-center w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex justify-between items-center gap-2">
            ...
            <div className="flex items-center gap-2 flex-grow max-w-[160px] sm:max-w-md justify-end">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="block w-full pl-7 sm:pl-9 pr-3 py-1.5 border border-slate-300 rounded-lg sm:rounded-xl leading-5 bg-slate-50 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 text-xs sm:text-sm transition-colors"
                  value={searchTerm}
