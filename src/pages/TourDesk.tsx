          ...
          <div className="flex flex-col sm:flex-row justify-between items-center py-2 sm:py-4 gap-2 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-4 w-full md:w-auto overflow-hidden">
              ...
              <h2 className="text-sm sm:text-2xl font-bold text-slate-900 truncate">
                {t(`সিলেটের ${tourSpots.length}টি দর্শনীয় স্থান`, `Top ${tourSpots.length} Tourist Spots`)}
              </h2>
            </div>
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              ...
              {editMode && (
                <div className="flex gap-1 sm:gap-2 flex-shrink-0">
                  <button
                    onClick={handleAdd}
                    className="flex items-center gap-2 bg-red-600 text-white p-1.5 sm:p-2 rounded-lg sm:rounded-xl hover:bg-red-700 transition-colors whitespace-nowrap"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 bg-amber-500 text-white p-1.5 sm:p-2 rounded-lg sm:rounded-xl hover:bg-amber-600 transition-colors whitespace-nowrap text-[10px] sm:text-sm font-bold px-2 sm:px-3"
                  >
                    Restore
                  </button>
                </div>
